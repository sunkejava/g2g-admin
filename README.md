...
**Docker 部署无需安装 .NET 运行时！** 其他方式需安装 [.NET 10 运行时](https://dotnet.microsoft.com/download/dotnet/10.0)。

详见：[跨平台部署指南](DEPLOYMENT_PLATFORMS.md)

### 环境要求

- .NET 10 SDK（开发）或 .NET 10 运行时（生产）
- Node.js 20+（仅开发时需要）
